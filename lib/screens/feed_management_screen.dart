...
// ==========================================
// 1. MODEL GIẢ LẬP DỮ LIỆU BÀI VIẾT (ADMIN)
// ==========================================
class AdminPostModel {
  ...
  final bool isReported; // Đánh dấu bài viết bị báo cáo vi phạm
...
class _FeedManagementScreenState extends State<FeedManagementScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final filteredPosts = _mockPosts.where((post) {
      final matchesSearch = post.authorName.toLowerCase().contains(_searchQuery.toLowerCase()) || 
                            post.contentSnippet.toLowerCase().contains(_searchQuery.toLowerCase());
      final matchesFilter = _selectedFilter == 'Tất cả' ||
                            (_selectedFilter == 'Bị báo cáo' && post.isReported) ||
                            (_selectedFilter == 'An toàn' && !post.isReported);
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: const InputDecoration(
                  hintText: 'Tìm theo người đăng hoặc nội dung...',
            ...
            Container(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  items: ['Tất cả', 'An toàn', 'Bị báo cáo']
                      .map((e) => DropdownMenuItem(value: e, child: Text(e, style: TextStyle(color: e == 'Bị báo cáo' ? Colors.red : Colors.black87, fontWeight: e == 'Bị báo cáo' ? FontWeight.bold : FontWeight.normal))))
                      .toList(),
              ...
              child: SingleChildScrollView(
                ...
                child: SingleChildScrollView(
                  ...
                  child: DataTable(
                    ...
                    rows: filteredPosts.map((post) => _buildDataRow(context, post)).toList(),
                  ),
                ),
              ),
            ),
  ...
  DataRow _buildDataRow(BuildContext context, AdminPostModel post) {
    return DataRow(
      color: MaterialStateProperty.resolveWith((states) => post.isReported ? Colors.red[50] : Colors.white), // Highlight bài bị report
      cells: [
        // 1. Tác giả
        DataCell(
          Row(
          ...
          Row(
            children: [
              IconButton(
                ...
                onPressed: () => _showPostDetailModal(context, post), // Hiển thị chi tiết
              ),
              IconButton(
  ...
  void _showPostDetailModal(BuildContext context, AdminPostModel post) {
    showDialog(
      context: context,
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    onPressed: () => Navigator.pop(ctx), // Xóa bài viết ngay từ Modal
